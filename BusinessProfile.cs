...
namespace BMC2021
{
    ...
    public partial class BusinessProfile : Form {
        ...
        private void load_Calendar() {
            ...
            //DateTime [] scheduledDates = new DateTime[] { };
        ...
        private void BusinessProfile_Load(object sender, EventArgs e) {
            // TODO: This line of code loads data into the 'pOSDBDataSet.Reminders' table. You can move, or remove it, as needed.
            this.remindersTableAdapter.Fill(this.pOSDBDataSet.Reminders);
        ...
        private void monthlytable_Paint(object sender, PaintEventArgs e) {
        ...
        private void lb_cuser_Click(object sender, EventArgs e) {
